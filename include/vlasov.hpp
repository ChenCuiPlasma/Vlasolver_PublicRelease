...
class Vlasolver {
  ...
  public:
    ...
    /// Closure of the distribution function at objects embedded in the simulation domain.
    void extrapolate_distribution() const;
    ...
    void pfc_update(double dt, int axis, int sp) const {
        ...
        Kokkos::parallel_for(
            ...
            KOKKOS_CLASS_LAMBDA(const int i, const int j, const int iv, const int jv) {
                ...
                // 1st order flux, it should be monotone
        ...
        // Step 2: Compute the limited PFC update increment for every cell.
        //
        ...
        Kokkos::parallel_for(
            ...
            KOKKOS_CLASS_LAMBDA(const int i, const int j, const int iv, const int jv) {
                ...
                double ep_left    = min(ep_lo.second, ep_c.first);
                double ep_right   = min(ep_c.second, ep_hi.first);
        ...
        Kokkos::parallel_for(
            ...
            KOKKOS_CLASS_LAMBDA(const int i, const int j, const int iv, const int jv) {
                ...
                // meaningfully negative distribution
    ...
    void advance(double dt) {
        ...
        Kokkos::printf("(VlasovSolver) Boundary closure\n");
