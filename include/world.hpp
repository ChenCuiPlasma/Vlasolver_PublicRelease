...
/**
 * World struct contains physical properties of the particles, fields, and the embedded object.
...
struct World {
     ...
     * eta(i,j) = S(x,y), the signed value of the surface expression of the embedded object.
     * S = 0 is the surface of the embedded object.
     * S < 0 is the exterior of the computational domain (interior of the embedded object).
     * S > 0 is the interior of the computational domain (exterior of the embedded object).
